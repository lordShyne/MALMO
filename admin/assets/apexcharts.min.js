      ...
      , E = function() {
        ...
        return r(t, [{
            ...
            value: function(t) {
                ...
                if (a && "object" === i(a)) {
                    var l, h, c, d, g, u, p = {};
                    p = -1 !== ["line", "area", "bar", "candlestick", "boxPlot", "rangeBar", "rangeArea", "bubble", "scatter", "heatmap", "treemap", "pie", "polarArea", "donut", "radar", "radialBar"].indexOf(a.chart.type) ? r[a.chart.type]() : r.line(),
                    a.chart.stacked && "bar" === a.chart.type && (p = r.stackedBars()),
                    null !== (l = a.chart.brush) && void 0 !== l && l.enabled && (p = r.brush(p)),
                    a.chart.stacked && "100%" === a.chart.stackType && (a = r.stacked100(a)),
                    null !== (h = a.plotOptions) && void 0 !== h && null !== (c = h.bar) && void 0 !== c && c.isDumbbell && (a = r.dumbbell(a)),
                    ...
                    (null !== (d = (a = this.checkForCatToNumericXAxis(this.chartType, p, a)).chart.sparkline) && void 0 !== d && d.enabled || null !== (g = window.Apex.chart) && void 0 !== g && null !== (u = g.sparkline) && void 0 !== u && u.enabled) && (p = r.sparkline(p)),
                    n = x.extend(o, p)
                }
                var f = x.extend(n, window.Apex);
                return o = x.extend(f, a),
                ...
                for (var x = 0; x < a.x.length; x++)
                    ...
                    !isNaN(g)) {
                        ...
                        if ("bubble" === h.config.chart.type)
                            ...
                            u = a.y[x],
                            u = new H(this.ctx).centerTextInBubble(u, s, p).y;
                        else
                            void 0 !== b && (v = y(b));
        ...
        return r(t, [{
            ...
            value: function(t) {
                var e = t.x
                  ...
                  , v = e + parseFloat(d * u)
                  , y = i + parseFloat(c * u);
                f.globals.isXNumeric && !f.globals.isBarHorizontal && (v = e + parseFloat(d * (u + 1)),
                y = i + parseFloat(c * (u + 1)) - b);
                ...
                void 0 !== g && this.barCtx.isRangeBar && (y = g,
                S = g);
                var T = L.offsetX
                  , M = L.offsetY
                  , X = {
                ...
                return C = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(E) : this.calculateColumnsDataLabelsPosition(E),
                p.attr({
                    cy: C.bcy,
                    cx: C.bcx,
                    j: o,
            ...
            value: function(t) {
                ...
                if (e = s.globals.isXNumeric ? c - d / 2 + y : c - A + d / 2 + y,
                k) {
                    e = e + u.height / 2 - v / 2 - 2
                }
                var S = this.barCtx.series[r][o] < 0
                  , C = h;
                switch (this.barCtx.isReversed && (C = h - g + (S ? 2 * g : 0),
                h -= g),
                x.position) {
                case "center":
                ...
                if (this.barCtx.lastActiveBarSerieIndex === n && b.enabled) {
                    ...
                    i = S ? C - L.height / 2 - w - b.offsetY + 18 : C + L.height + w + b.offsetY - 18,
                    a = e + b.offsetX
                }
        ...
        return r(t, [{
            ...
            value: function(t) {
                var e = t.realIndex
                  ...
                  , C = this.w
                  , L = new m(this.ctx);
                a || (a = this.barOptions.distributed ? C.globals.stroke.colors[s] : C.globals.stroke.colors[e]),
                C.config.series[r].data[s] && C.config.series[r].data[s].strokeColor && (a = C.config.series[r].data[s].strokeColor),
                ...
                T.count > 0 && s >= C.globals.dataPoints - T.count && (I.node.setAttribute("stroke-dasharray", T.dashArray),
                I.node.setAttribute("stroke-width", T.strokeWidth),
                I.node.setAttribute("fill-opacity", T.fillOpacity)),
                void 0 !== u && void 0 !== p && (I.attr("data-range-y1", u),
                I.attr("data-range-y2", p)),
                new v(this.ctx).setSelectionFilter(I, e, s),
                c.add(I);
                ...
                return null !== M.dataLabels && w.add(M.dataLabels),
                M.totalDataLabels && w.add(M.totalDataLabels),
                c.add(w),
                k && c.add(k),
                c
            }
      ...
      , wt = function(t) {
        ...
        return r(s, [{
            ...
            value: function(t, e, i, a, s, r) {
                ...
                this.isHorizontal ? (o = (o = a = c.globals.gridHeight / c.globals.dataPoints) * parseInt(c.config.plotOptions.bar.barHeight, 10) / 100,
                null !== (l = c.globals.seriesGroups) && void 0 !== l && l.length && (o /= c.globals.seriesGroups.length),
                -1 === String(c.config.plotOptions.bar.barHeight).indexOf("%") && (o = parseInt(c.config.plotOptions.bar.barHeight, 10)),
                ...
                e = (a - o) / 2) : (n = i = c.globals.gridWidth / c.globals.dataPoints,
                n = c.globals.isXNumeric && c.globals.dataPoints > 1 ? (i = c.globals.minXDiff / this.xRatio) * parseInt(this.barOptions.columnWidth, 10) / 100 : n * parseInt(c.config.plotOptions.bar.columnWidth, 10) / 100,
                null !== (h = c.globals.seriesGroups) && void 0 !== h && h.length && (n /= c.globals.seriesGroups.length),
                -1 === String(c.config.plotOptions.bar.columnWidth).indexOf("%") && (n = parseInt(c.config.plotOptions.bar.columnWidth, 10)),
                ...
                t = c.globals.padHorizontal + (i - n) / 2);
                return {
                    x: t,
                    y: e,
                    yDivision: a,
