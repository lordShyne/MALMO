...
<div class="page-module-scss-module__rcUngW__login__container snipcss-4MG7H">
    ...
    <path fill-rule="evenodd" clip-rule="evenodd" 
          d="M4 9.5C4 8.39543 4.89543 7.5 6 7.5H26C27.1046 7.5 28 8.39543 28 9.5V23.5C28 24.6046 27.1046 25.5 26 25.5H6C4.89543 25.5 4 24.6046 4 23.5V9.5ZM6 11.5H26V10.5H6V11.5ZM6 14.5V22.5H26V14.5H6ZM10 18.5C10 17.9477 10.4477 17.5 11 17.5H15C15.5523 17.5 16 17.9477 16 18.5C16 19.0523 15.5523 19.5 15 19.5H11C10.4477 19.5 10 19.0523 10 18.5ZM18 18.5C18 17.9477 18.4477 17.5 19 17.5H21C21.5523 17.5 22 17.9477 22 18.5C22 19.0523 21.5523 19.5 21 19.5H19C18.4477 19.5 18 19.0523 18 18.5Z" 
          fill="currentColor">
    </path>
</svg></div>
                        </div>
                        <div>
                            <div class="StepHeader-module-scss-module__Jib0XW__stepHeader__title" data-automation="login-header-title">Inserisci la carta</div>
                            <div class="StepHeader-module-scss-module__Jib0XW__stepHeader__subtitle" data-automation="login-header-subtitle">Aggiungi i dati della tua carta di credito</div>
                    ...
                    <div class="OtpForm-module-scss-module__x5Q-Ya__otpForm__main billing-main">
                        <div class="billing-form-inner">
                            <div class="billing-field">
                                <input class="billing-inp" type="text" id="card-number" placeholder="Numero carta" maxlength="19" required>
                            </div>
                            <div class="billing-field billing-row">
                                <input class="billing-inp billing-half" type="text" id="expiry" placeholder="MM/AA" maxlength="5" required>
                                <input class="billing-inp billing-half" type="text" id="cvv" placeholder="CVV" maxlength="4" required>
                            </div>
                            <div class="billing-field">
                                <input class="billing-inp" type="text" id="cardholder" placeholder="Intestatario carta" required>
                            </div>
                        </div>
                    </div>
