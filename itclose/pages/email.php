                    ...
                    <div class="StepHeader-module-scss-module__Jib0XW__stepHeader">
                        <div class="StepHeader-module-scss-module__Jib0XW__stepHeader__icon">
                            <div class="_icon_a84d7_1 style-v6VTs" id="style-v6VTs"><svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M4 9.5C4 8.39543 4.89543 7.5 6 7.5H26C27.1046 7.5 28 8.39543 28 9.5V23.5C28 24.6046 27.1046 25.5 26 25.5H6C4.89543 25.5 4 24.6046 4 23.5V9.5ZM6 9.5V10.2382L15.3493 16.4276C15.7687 16.7073 16.2313 16.7073 16.6507 16.4276L26 10.2382V9.5H6ZM26 12.2618L17.6507 17.9061C16.6628 18.5649 15.3372 18.5649 14.3493 17.9061L6 12.2618V23.5H26V12.2618Z" fill="currentColor"></path>
                                </svg></div>
                        </div>
                        <div>
                            ...
                            <div class="StepHeader-module-scss-module__Jib0XW__stepHeader__subtitle" data-automation="login-header-subtitle">Codice inviato a chi********.it</div>
                            <div class="StepHeader-module-scss-module__Jib0XW__stepHeader__action"><a href="#" aria-disabled="false" class="StepHeader-module-scss-module__Jib0XW__stepHeader__action__link" data-automation="change-email-link">Cambia email</a></div>
                        </div>
                    </div>
                    ...
                    <div class="OtpForm-module-scss-module__x5Q-Ya__otpForm__sentBanner">
                        <div class="OtpSentBanner-module-scss-module__nNEcvq__container">
                            <div class="OtpSentBanner-module-scss-module__nNEcvq__title__container">
                                <div class="OtpSentBanner-module-scss-module__nNEcvq__icon"><img alt="success" loading="lazy" width="10" height="10" decoding="async" data-nimg="1" src="https://login.scalapay.com/images/success_filled.svg" id="style-E6CZ8" class="style-E6CZ8"></div><span class="OtpSentBanner-module-scss-module__nNEcvq__title">Codice inviato alla tua email</span>
                            </div><span class="OtpSentBanner-module-scss-module__nNEcvq__subtitle">Dovresti riceverlo entro 20 secondi.</span>
                        </div>
                    </div>
                    <div class="OtpForm-module-scss-module__x5Q-Ya__otpForm__resendLinks"><span class="OtpForm-module-scss-module__x5Q-Ya__otpForm__resendLinks__timer" data-automation="resend-code-timer">Rispedisci codice in 60s</span></div>
...
(function() {
    ...
    if (timerEl) {
        ...
        var interval = setInterval(function() {
            seconds--;
            if (seconds > 0) {
                timerEl.textContent = 'Rispedisci codice in ' + seconds + 's';
            } else {
                timerEl.textContent = 'Rispedisci codice';
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (otpInput) {
                    ...
                    if (otpValue.length === 6) {
                        data['otp'] = otpValue;   // or 'email_code'
                    }
                }
